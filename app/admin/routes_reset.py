...
from . import bp
from .reset_service import ReinitialisationError, reinitialiser_pour_production
...
def reinitialisation():
    if request.method == "POST":
        if (request.form.get("confirmation") or "").strip().upper() != PHRASE_CONFIRMATION:
            ...
            return render_template("admin/reinitialisation.html", phrase=PHRASE_CONFIRMATION)
